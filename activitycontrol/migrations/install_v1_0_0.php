...
class install_v1_0_0 extends \phpbb\db\migration\migration
{
    ...
    public function update_data()
    {
        return [
            ...
            ['config.add', ['ac_quarantine_posts', 1]], // ACTIVÉ par défaut
            ...
            ['config.add', ['ac_enable_ip_sync', 1]], // ACTIVÉ par défaut
            ...
            ['config.add', ['ac_first_activation', 0]], // Flag pour forcer sync au premier chargement (défaut 0, mis à 1 par enable_step)
